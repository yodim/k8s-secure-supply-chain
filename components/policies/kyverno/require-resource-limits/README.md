...
Standalone. Scoped to the `apps` namespace by default — adjust `namespaces:` under `match`. If your org standardizes on LimitRange defaults instead of hard enforcement, prefer that and run this policy in `Audit` as a reporting layer.
